...
public class ArcRotationHelper {
     ...
     */
    public static ArcRotationHelper create(@NonNull View targetView, @NonNull OnSlidingListener listener) {
        ...
        return new ArcRotationHelper(targetView.getContext(), x + width, y + height, listener);
    }

    private ArcRotationHelper(Context context, int pivotX, int pivotY, OnSlidingListener listener) {
        mPivotX = pivotX;
        mPivotY = pivotY;
    ...
    private static class InertialSlidingHandler extends Handler {
        ...
        ArcRotationHelper mHelper;

        InertialSlidingHandler(ArcRotationHelper helper) {
            mHelper = helper;
        }
